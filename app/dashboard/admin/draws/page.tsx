  ...
  return (
    <Layout role="admin" title="Admin Dashboard">
      <div className="px-4 py-6 sm:px-0">
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-gray-900">Draw Worksheet</h2>
          <p className="text-gray-600 mt-1">Review and manage draw requests</p>
        </div>
        ...
        <div className="bg-white shadow overflow-hidden sm:rounded-md">
          <ul className="divide-y divide-gray-200">
            {draws.map((draw) => (
              <li key={draw.id}>
                <Link href={`/dashboard/admin/draws/${draw.id}`} className="block hover:bg-gray-50">
