...
export default function BuilderLoanDetailPage() {
  ...
  return (
    <Layout role="builder" title="Builder Portal">
      <div className="px-4 py-6 sm:px-0">
        <div className="mb-6">
          <Link href="/dashboard/builder" className="text-blue-600 hover:text-blue-800 text-sm font-medium">
            ← Back to My Jobs
          </Link>
        </div>
        ...
        <div className="bg-white shadow overflow-hidden sm:rounded-lg">
          <div className="px-4 py-5 sm:px-6 border-b border-gray-200 flex justify-between items-center">
            ...
            <Link
              href={`/dashboard/builder/loans/${loanId}/draws/new`}
